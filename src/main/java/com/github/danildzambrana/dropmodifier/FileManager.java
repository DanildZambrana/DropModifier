...
public final class FileManager {
     ...
     */
    public @NotNull
    FileConfiguration getBukkitFile() {
        if (bukkitFile == null) {
            reloadFile();
        }
     ...
     */
    @SafeVarargs
    public final String getString(String path, @NotNull Map.Entry<String, String>... placeholders) {
        String text = getBukkitFile().getString(path, "");
     ...
     * @return a string from the file.
     */
    public String getString(String path, @NotNull List<Map.Entry<String, String>> placeholders) {
        String text = getBukkitFile().getString(path, "");
        for (Map.Entry<String, String> placeholder : placeholders) {
            text = text.replace(placeholder.getKey(), placeholder.getValue());
        }
    ...
    @SafeVarargs
    public @NotNull
    final String getColouredString(String path, @NotNull Map.Entry<String, String>... placeholders) {
     ...
     * @return a string with color codes.
     */
    public @NotNull String getColouredString(String path, @NotNull List<Map.Entry<String, String>> placeholders) {
        return ChatColor.translateAlternateColorCodes('&', getString(path, placeholders));
    }
    ...
    @SafeVarargs
    public @NotNull
    final String getStripedString(String path, @NotNull Map.Entry<String, String>... placeholders) {
     ...
     * @return a string without color codes.
     */
    public @NotNull String getStripedString(String path, @NotNull List<Map.Entry<String, String>> placeholders) {
        return ChatColor.stripColor(getColouredString(path, placeholders));
    }
    ...
    List<String> getColouredList(String path,
                                 @NotNull Map.Entry<String, String>... placeholders) {
        return getColouredList(path, Arrays.stream(placeholders).toList());
    }
     ...
     * @return a strings without color codes.
     */
    public @NotNull List<String> getColouredList(String path,
                                                 @NotNull List<Map.Entry<String, String>> placeholders) {
